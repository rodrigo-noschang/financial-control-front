	...
	return (
		<DayPicker
			...
			classNames={{
				...
				weekday: cn(
					"text-standard-color rounded-md flex-1 font-normal select-none",
				...
				today: cn(
					"text-accent-foreground rounded-md border-1 border-box-bg rounded-md",
